...
const navItems = [
  ...
  { href: "/admin/treasury", label: "Treasury", icon: "dollar" },
...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-navy-50">
      {/* Sidebar */}
      <aside className="w-64 border-r border-navy-200 bg-navy-800 text-white">
        <div className="flex h-16 items-center gap-2 border-b border-navy-700 px-6">
          <span className="text-lg font-bold text-gold-400">CivicState</span>
          <span className="rounded bg-gold-500/20 px-2 py-0.5 text-xs font-semibold text-gold-300">
            Admin
          </span>
        </div>
